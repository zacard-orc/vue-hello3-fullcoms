...
function reg (key) {
  /* eslint-disable @typescript-eslint/no-use-before-define */
  if (VXETable.Table) {
    console.error('vxe.error.useErr', [key])
  }
  VXETable[`_${key}`] = 1
}
...
Object.defineProperty(VXETable, 'buttons', {
  get () {
    console.warn('vxe.error.delProp', ['buttons', 'commands'])
    return commands
  }
})
 ...
 * 获取当前的 zIndex
 */
Object.defineProperty(VXETable, 'zIndex', { get: () => -1 })

/**
 * 获取下一个 zIndex
 */
Object.defineProperty(VXETable, 'nextZIndex', { get: () => 1 })
